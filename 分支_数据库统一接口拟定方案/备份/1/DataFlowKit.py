...
class TableAccessManager:
    ...
    def _match_table_entry(self, table_name):
    ...
    def check_table_permission(self, table_name, permissions, operation="table_access", fields=None,
        ...
        entry = self._match_table_entry(table_name)
        missing_permissions = []
        missing_fields = []
    ...
    def read_table(self, table_name, limit=None, offset=0, include_rowid=False, fields=None):
        ...
        """
        self.check_table_permission(table_name, ["read_table"], operation="read_table", fields=fields, field_action="read")
    ...
    def backup_table(self, table_name, backup_name=None):
        ...
        self.check_table_permission(table_name, ["read_table", "create_table"], operation="backup_table")
        if not backup_name:
    ...
    def drop_table(self, table_name, backup=False):
        ...
        if not self.table_exists(table_name):
            raise ValueError(f"表不存在：{table_name}")
        self.check_table_permission(table_name, ["drop_table"], operation="drop_table")
