...
class DataSourceManagerWindow:
    ...
    def _build_ui(self, *, db_path=""):
        ...
        db_row.addWidget(self.refresh_tables_button)
        db_row.addWidget(qt.QtWidgets.QLabel("表："))
        db_row.addWidget(self.table_combo)
        db_row.addWidget(self.load_table_button)
